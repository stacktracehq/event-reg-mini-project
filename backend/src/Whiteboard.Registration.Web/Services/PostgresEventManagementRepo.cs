            ...
            using (var dbConnection = GetConnection())
            {
                ...
                return Task.FromResult(
                    dbConnection.Execute(
                        @"INSERT INTO event_management (id, title, description, event_location, event_start_date, event_end_date)
                        VALUES(@Id, @Title, @Description, @EventLocation, @EventStartDate, @EventEndDate)",
                        new {Id=value.Id, Title =value.Title.Value, Description = value.Description.Value, EventLocation = value.EventLocation.Value, EventStartDate = value.EventStartDate.Value, EventEndDate = value.EventEndDate.Value}
