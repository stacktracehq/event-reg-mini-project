...
namespace Whiteboard.Registration.Domain.Tests
{
    public class TinyTypeTest
    {
        ...
        // We can define some classes that are just scoped to the test
        // This allows us to test the functionality without needing
        // the TinyType<T> constructor. Why might this be useful?
